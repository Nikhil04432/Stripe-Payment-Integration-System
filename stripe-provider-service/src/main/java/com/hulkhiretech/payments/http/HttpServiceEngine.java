...
public class HttpServiceEngine {
    ...
    */
    ...
    public ResponseEntity<String> makeHttpCall( HttpRequest httpRequest) {
        ...
        try {
            ResponseEntity<String> httpResponse = restClient.method(httpRequest.getHttpMethod())   // here httpRequest.getMethod() returns HttpMethod.Get/post aaccording to the request we want to make
